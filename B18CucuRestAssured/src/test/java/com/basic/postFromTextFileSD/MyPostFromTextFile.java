...
public class MyPostFromTextFile {
	...
	public void user_hit_the_post_request_with_json_data() throws IOException{
		...
		File file = new File("C:\\Users\\ASHA_MAITY\\EclipseWorkspace\\B18CucuRestAssured\\src\\test\\java\\com\\basic\\postFromTextFileSD\\user.json");
	    //String content = null;
	...
	public void user_validate_the_id_is_not_null(){
		...
		resp.then().assertThat().body("id", notNullValue());     //matchers
