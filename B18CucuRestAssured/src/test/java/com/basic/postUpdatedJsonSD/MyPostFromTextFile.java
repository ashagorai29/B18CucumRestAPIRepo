...
public class MyPostFromTextFile {
	...
	public void user_hit_the_post_request_with_json_data(String username) throws IOException{
		...
		//Read data from file
		String data = ""; 
	    data = new String(Files.readAllBytes(Paths.get("C:\\Users\\ASHA_MAITY\\EclipseWorkspace\\B18CucuRestAssured\\src\\test\\java\\com\\basic\\postUpdatedJsonSD\\user.json"))); 
	    ...
	    object.put("name", username+myTimeStamp);
